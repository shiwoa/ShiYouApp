...
public class BookPlaybackAdapter extends BaseQuickAdapter<String,BaseViewHolder>{

    private Context context;

    public BookPlaybackAdapter(int layoutResId, Context context, @Nullable List<String> data) {
