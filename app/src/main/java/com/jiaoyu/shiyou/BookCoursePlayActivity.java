...
public class BookCoursePlayActivity extends BaseActivity{
    ...
    private BookCourseInforFragment inforFragment; //简介
    private BookCourseRelevantFragment relevantFragment;//相关
    ...
    protected void initData() {
        ...
        inforFragment = new BookCourseInforFragment();
        relevantFragment = new BookCourseRelevantFragment();
    ...
    protected void addListener() {
        back.setOnClickListener(view -> BookCoursePlayActivity.this.finish());
    }
    ...
    private void initMagicIndicator() {
        ...
        CommonNavigator commonNavigator = new CommonNavigator(BookCoursePlayActivity.this);
