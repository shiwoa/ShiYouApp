...
public class EntityPublic implements Serializable {
    ...
    public void setDataOne(EntityPublic dataOne) {
    ...
    public void setCourseDto(EntityPublic courseDto) {
    ...
    public void setTeacherCommentList(List<EntityPublic> teacherCommentList) {
        this.teacherCommentList = teacherCommentList;
    }
    ...
    public List<EntityPublic> getTeacherCommentTagsList() {
        return teacherCommentTagsList;
    }

    public void setTeacherCommentTagsList(List<EntityPublic> teacherCommentTagsList) {
        this.teacherCommentTagsList = teacherCommentTagsList;
    }
    ...
    public List<EntityPublic> getTeacherConsultList() {
        return teacherConsultList;
    }

    public void setTeacherConsultList(List<EntityPublic> teacherConsultList) {
        this.teacherConsultList = teacherConsultList;
    }

    private List<CommentEntity> queryTeacherAssessList;

    public List<CommentEntity> getQueryTeacherAssessList() {
        return queryTeacherAssessList;
    }

    public void setQueryTeacherAssessList(List<CommentEntity> queryTeacherAssessList) {
        this.queryTeacherAssessList = queryTeacherAssessList;
    }
    ...
    public List<EntityPublic> getCourseHomeBanner() {
        return courseHomeBanner;
    }

    public void setCourseHomeBanner(List<EntityPublic> courseHomeBanner) {
        this.courseHomeBanner = courseHomeBanner;
    }
    ...
    public void setDataList(List<EntityPublic> dataList) {
    ...
    public void setShiyouList(List<EntityPublic> shiyouList) {
        this.shiyouList = shiyouList;
    }
    ...
    public void setShekeList(List<EntityPublic> shekeList) {
        this.shekeList = shekeList;
    }

    public List<EntityPublic> getPackageCoruseList() {
        return packageCoruseList;
    }

    public void setPackageCoruseList(List<EntityPublic> packageCoruseList) {
        this.packageCoruseList = packageCoruseList;
    }
    ...
    public void setCourseKpointList(List<EntityPublic> courseKpointList) {
    ...
    public void setuMayAlsoLike(List<EntityPublic> uMayAlsoLike) {
        this.uMayAlsoLike = uMayAlsoLike;
    }
    ...
    public void setNewCourses(List<EntityPublic> newCourses) {
    ...
    public void setExcellentCourse(List<EntityPublic> excellentCourse) {
    ...
    public void setPostClass(List<EntityPublic> postClass) {
