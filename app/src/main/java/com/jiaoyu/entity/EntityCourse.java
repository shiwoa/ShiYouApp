...
public class EntityCourse implements Serializable {
	...
	public List<EntityCourse> childSubjectList;
	...
	public void setColTagNames(String colTagNames) {
		this.colTagNames = colTagNames;
	}
	...
	public void setHotArticle(int hotArticle) {
