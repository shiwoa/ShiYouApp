...
abstract class ZLTextViewBase extends ZLView {
    ...
    public abstract ZLColor getSelectionYellowLineOption();

    public abstract ZLColor getSelectionGreenLineOption();

    public abstract ZLColor getSelectionBlueLineOption();

    public abstract ZLColor getSelectionPurpleLineOption();
