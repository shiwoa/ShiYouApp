...
public class ZLTextBaseStyle extends ZLTextStyle {
    ...
    public final ZLIntegerRangeOption LineSpaceOption =
            new ZLIntegerRangeOption(GROUP, "Base:lineSpacing", 5, 20, 16);
    ...
    public ZLTextBaseStyle(String fontFamily, int fontSize) {
        ...
        Log.d("fontSize", "raw font size=" + String.valueOf(fontSize));
        Log.d("fontSize", "dpi=" + ZLibrary.Instance().getDisplayDPI());
        fontSize = fontSize * ZLibrary.Instance().getDisplayDPI() / 320 * 2 + 2;
        Log.d("fontSize", "fined font size=" + String.valueOf(fontSize));
        //字号范围
        FontSizeOption = new ZLIntegerRangeOption(GROUP, "Base:fontSize", 15, 72, fontSize);
    }
