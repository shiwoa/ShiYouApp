...
public final class Booknote extends ZLTextFixedPosition {
    ...
    Booknote(long id, long bookId, String bookTitle, String text, Date creationDate, Date modificationDate, Date accessDate, int accessCount, String modelId, int paragraphIndex, int elementIndex, int charIndex, boolean isVisible) {
    ...
    public Booknote(Book book, String modelId, ZLTextWordCursor cursor, int maxLength, boolean isVisible) {
        this(book, modelId, cursor, createBooknoteText(cursor, maxLength), isVisible);
    }

    public Booknote(Book book, String modelId, ZLTextWordCursor cursor, int maxLength, boolean isVisible, String info) {
        this(book, modelId, cursor, info, isVisible);
    }

    public Booknote(Book book, String modelId, ZLTextPosition position, String text, boolean isVisible) {
        super(position);
    ...
    private static String createBooknoteText(ZLTextWordCursor cursor, int maxWords) {
    ...
    public void save() {
        if (myIsChanged) {
            myId = BooksDatabase.Instance().saveBooknote(this);
            myIsChanged = false;
        }
    }
    ...
    public static class ByTimeComparator implements Comparator<Booknote> {
        public int compare(Booknote bm0, Booknote bm1) {
