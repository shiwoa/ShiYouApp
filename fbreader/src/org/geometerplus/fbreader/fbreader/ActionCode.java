...
public interface ActionCode {
    ...
    //String SHOW_TOPNAVIGATION = "topnavigate";
    ...
    String SPACE_SMALL = "smallLineSpace";
    String SPACE_MIDDLE = "middleLineSpace";
    String SPACE_BIG = "bigLineSpace";
    String SPACE_ORIGINAL = "originalLineSpace";
    ...
    String SELECTION_DELETE_LINE = "selectionDelete";
    String SELECTION_COPY_TO_CLIPBOARD = "selectionCopyToClipboard";
    String SELECTION_BAIKE = "selectionbaike";
    String SELECTION_DRAW_YELLOW_LINE = "selectionDrawYellowLine";
    String SELECTION_DRAW_GREEN_LINE = "selectionDrawGreenLine";
    String SELECTION_DRAW_BLUE_LINE = "selectionDrawBlueLine";
    String SELECTION_DRAW_PURPLE_LINE = "selectionDrawPurpleLine";
