...
public class TOCActivity extends ListActivity {
    ...
    private final class TOCAdapter extends ZLTreeAdapter {
        ...
        void openBookText(TOCTree tree) {
            ...
            if (reference != null) {
                final FBReaderApp fbreader = (FBReaderApp) ZLApplication.Instance();
                int paragraphsNumber = fbreader.Model.getTextModel().getParagraphsNumber();
                if (FBReader.probationRate > 0) {
                    ...
                    if (reference.ParagraphIndex > limitParagraphsNumber) {
                        ...
                        String tipString = String.format(getResources().getString(R.string.exceed_probation_limit), pageLimit);
                        CustomToast.showToast(TOCActivity.this, tipString, Toast.LENGTH_SHORT);
                        return;
                    }
                }
                finish();
