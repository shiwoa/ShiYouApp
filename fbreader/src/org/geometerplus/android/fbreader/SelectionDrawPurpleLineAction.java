...
public class SelectionDrawPurpleLineAction extends FBAndroidAction {
    SelectionDrawPurpleLineAction(FBReader baseActivity, FBReaderApp fbreader) {
    ...
    protected void run(Object... params) {
        ...
        new BookSelection(Reader.Model.Book, BaseActivity.bookID,
                fbview.getSelectionStartPosition(), endParagraphIndex, endElementIndex, text, "4").save();
