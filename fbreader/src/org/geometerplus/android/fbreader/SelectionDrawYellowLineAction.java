...
public class SelectionDrawYellowLineAction extends FBAndroidAction {
    SelectionDrawYellowLineAction(FBReader baseActivity, FBReaderApp fbreader) {
    ...
    protected void run(Object... params) {
        ...
        new BookSelection(Reader.Model.Book, BaseActivity.bookID,
                fbview.getSelectionStartPosition(), endParagraphIndex, endElementIndex, text, "1").save();
