...
public class WallpaperPreference extends ZLStringListPreference {
    private final ZLStringOption myOption;

    public WallpaperPreference(Context context, ColorProfile profile, ZLResource resource, String resourceKey) {
...
//		final int size = 1 + predefined.size() + external.size();
        final int size = predefined.size();
